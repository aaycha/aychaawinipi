...
public class RestaurationRestrictionsController {
    ...
    @FXML private TableView<Restauration> restrictionsTable;
    @FXML private TableColumn<Restauration, Long> colRestId;
    @FXML private TableColumn<Restauration, String> colRestLibelle;
    @FXML private TableColumn<Restauration, String> colRestDescription;
    @FXML private TableColumn<Restauration, Boolean> colRestActif;
    ...
    public void initialize() {
        try {
            colRestId.setCellValueFactory(cellData -> 
            ...
            colRestActif.setCellValueFactory(cellData -> 
    ...
    void onTableClick(MouseEvent event) {
        selectedRestriction = restrictionsTable.getSelectionModel().getSelectedItem();
    ...
    void onSupprimer() {
        if (selectedRestriction == null) {
            showAlert(Alert.AlertType.WARNING, "Sélection requise", "Veuillez sélectionner une restriction à supprimer");
            return;
        }
        Alert confirmAlert = new Alert(Alert.AlertType.CONFIRMATION);
        confirmAlert.setTitle("Confirmation");
        confirmAlert.setHeaderText("Supprimer cette restriction ?");
        confirmAlert.setContentText("ID: " + selectedRestriction.getId() + "\nLibellé: " + selectedRestriction.getRestrictionLibelle());
    ...
    private void loadRestrictionInForm(Restauration restriction) {
        ...
        inputDescription.setText(restriction.getRestrictionDescription() != null ? restriction.getRestrictionDescription() : "");
