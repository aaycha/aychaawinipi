...
public class SceneUtil {
    ...
    public static void applyTheme(Scene scene) {
        ...
        if (themeUrl == null)
            throw new IllegalStateException("CSS introuvable: " + (darkMode ? CSS_DARK : CSS_LIGHT));
        if (baseUrl == null)
    ...
    public static void loadBackgroundImage(ImageView imageView) {
        if (imageView == null)
            return;
        URL url = SceneUtil.class.getResource("/Feryel/images/space_bg.png");
        if (url == null)
            url = SceneUtil.class.getResource("/Feryel/images/logo.png");
        if (url != null)
    ...
    public static void loadLogoImage(ImageView imageView) {
        if (imageView == null)
            return;
        URL url = SceneUtil.class.getResource("/Feryel/images/logo.png");
        if (url != null)
            imageView.setImage(new Image(url.toExternalForm()));
    }
    ...
    public static <T> void switchToWithData(String fxmlPath, String title, T data) {
        try {
            ...
            // ✅ passer data (même si null) - compatible Java 11
