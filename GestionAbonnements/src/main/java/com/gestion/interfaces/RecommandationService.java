...
public interface RecommandationService {
    ...
    /**
     * Top N recommandations par utilisateur (ex: top 5 par Score DESC). API: GET
     * /api/recommandations/user/:userId?contexte=couple
     */
    ...
    List<Long> trouverUsersSimilaires(Long userId, int limite);
